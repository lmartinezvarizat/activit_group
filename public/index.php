...
//$response = Request::forge('index', false)->execute()->response();
if (strpos($_SERVER['REQUEST_URI'], '/admin') === false) {
    $response = Request::factory('index', true)->execute()->response();
} else {
...
/*
 *
 * RewriteRule     ^(.*)\.html    /page.htm?URL=$1       [QSA]
    RewriteRule     ^/page.htm     /cms/page.htm          [QSA]
    RewriteRule     ^/cms/(.*)     -                      [L]
    RewriteRule     ^/admin$       /admin/index.htm       [N]
    RewriteRule     ^/admin/(.*)   /cms/admin/$1          [N]
    RewriteRule     ^/data/(.*)    -                      [L]
